...
<head>
  ...
  <title>Sadarberbagi | Register</title>
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="active"><a href="../pages/daftar">DAFTAR</a></li>
...
<div style="background-color:#F2F3F5">
        ...
        <div class="row">
         ...
         <form class="form-horizontal">
            <center>
                  ...
                  <p>Jadilah bagian dari perubahan hari ini juga</p>

                  <div class="form-group">
                    <div class="col-lg-12">
                      <input type="text" class="form-control" id="inputNama" placeholder="Nama Anda/Komunitas">
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-lg-12">
                  ...
                  <div class="form-group">
                    <div class="col-lg-12">
                      <input type="text" class="form-control" id="inputEmail2" placeholder="Re-Enter Email">
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-lg-12">
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    <div class="col-lg-12">
                      <input type="checkbox"> Menerima bulletin mingguan kami dan update lainnya
                    </div>
                  </div>
                  <button type="button" class="btn btn-success btn-block">Daftar</button>
                  <small>Dengan mendaftar, kamu menyetujui <a href="#">syarat dan ketentuan</a> kami serta <a href="#">kebijakan privasi</a>.</small>
                </form>
                ...
                <div class="row omb_row-sm-offset-3 omb_loginOr">
                  <div class="col-xs-12 col-sm-12">
                    <hr class="omb_hrOr">
                      <b><span class="omb_spanOr">ATAU</span></b>
                  </div>  
                </div>
                <br>
                ...
                <p>Sudah Punya Akun? <a href="../pages/masuk">Log in</a></p>
      ...
      <br><br>
        <center>
          <div style="background-color:#EEE2EC;height:0.5px"></div>
