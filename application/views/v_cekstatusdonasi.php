...
<head>
  ...
  <title>Sadarberbagi | Cek Status Donasi</title>
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="active"><a href="../pages/cekstatusdonasi">STATUS DONASI</a></li>
            </ul>
          </div>
        </div>
      </nav>
      ...
      <div class="container">
        <div class="row">
         ...
         <form class="form-horizontal">
            <center>
              <h3>Cek Status Donasi</h3>
              <p>Masukkan <strong>email</strong> dan <strong>ID Donasi</strong> untuk mengetahui status / mengkonfirmasikan donasi Anda</p>
              ...
              <div class="form-group">
                <div class="col-lg-12">  
                  <input type="text" class="form-control" id="inputIdDonasi" placeholder="ID Donasi">
                </div>
              </div>
